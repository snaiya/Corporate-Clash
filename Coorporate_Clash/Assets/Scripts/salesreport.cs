...
{
	public static Dictionary<string, int> Luxury_BuildingType_Count = new Dictionary<string, int>() 
	{ 
		{ "Building_F", 0 }, 
		{ "Building_G", 0 } 
	};
	public static Dictionary<string, int> Alleyway_BuildingType_Count = new Dictionary<string, int>() 
	{ 
		{ "Building_F", 0 }, 
		{ "Building_G", 0 } 
	};
	public static Dictionary<string, int> Street_BuildingType_Count = new Dictionary<string, int>() 
	{ 
		{ "Building_F", 0 }, 
		{ "Building_G", 0 } 
	};
	...
	{
		{"Luxury_G", 18}, {"Luxury_F", 20},  
		{"Alleyway_G", 12}, {"Alleyway_F", 15}, 
		{"Street_G", 7}, {"Street_F", 9}
	};

	// FETCH THIS DICTIONARY FOR SALESREPORT
	public static Dictionary<string, int> NetProfit = new Dictionary<string, int>()
	{
		{"Luxury_G", 0}, {"Luxury_F", 0},
	 	{"Alleyway_G", 0}, {"Alleyway_F", 0}, 
	 	{"Street_G", 0}, {"Street_F", 0}
	};

	
	public static int round_profit = 0;
	...
	public static void calculateProfitLuxury()
	{
		...
		variable.total_profit += temp_profit_f + temp_profit_g;
		round_profit += temp_profit_f + temp_profit_g;
	}
	...
	{
		variable.round = variable.round + 1;
